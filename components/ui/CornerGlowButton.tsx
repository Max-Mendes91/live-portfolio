...
const CornerGlowButton: React.FC<CornerGlowButtonProps> = ({
  ...
  const buttonClasses = `group relative inline-flex h-12 items-center justify-center px-8 py-3.5 text-[10px] font-medium uppercase tracking-[0.25em] text-white transition-all duration-300 hover:text-white/90 ${className}`;
