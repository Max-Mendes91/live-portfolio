...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!termsConditions) return { title: 'Terms & Conditions | Max Mendes' };

  return {
    title: `${termsConditions.title} | Max Mendes`,
    description: 'Terms and Conditions for maxmendes.dev. Rules and guidelines for using this website.',
    robots: {
      index: false,
      follow: false,
    },
    alternates: {
      canonical: getFullUrl('/en/terms'),
      languages: {
