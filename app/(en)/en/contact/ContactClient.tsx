...
const ContactClient: React.FC<ContactClientProps> = ({ dictionary }) => {
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-6 rounded-2xl bg-[#080808] border border-white/5">
                  ...
                  <div>
                    ...
                    <span className="text-white font-light">{contact.availabilityHours}</span>
                    <span className="text-zinc-500 text-sm block mt-1">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <h2 className="text-3xl font-normal tracking-tight text-white mb-6">
              {contact.notSure.title}
            </h2>
            <p className="text-zinc-400 text-lg mb-10 max-w-xl mx-auto font-light">
              {contact.notSure.description}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <CornerGlowButton href="/en/services">Web Development</CornerGlowButton>
              <CornerGlowButton href="/en/projects">View Portfolio</CornerGlowButton>
            </div>
          </motion.div>
        </div>
      </section>
