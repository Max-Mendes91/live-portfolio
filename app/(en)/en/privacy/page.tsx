...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!privacyPolicy) return { title: 'Privacy Policy | Max Mendes' };

  return {
    title: `${privacyPolicy.title} | Max Mendes`,
    description: 'Privacy Policy for maxmendes.dev. Information about data collection, processing, and your rights under GDPR.',
    robots: {
      index: false,
      follow: false,
    },
    alternates: {
      canonical: getFullUrl('/en/privacy'),
      languages: {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative z-10 bg-background">
        <Navbar locale="en" dictionary={dictionary.nav} />
      ...
      <div className="sticky bottom-0 z-0 h-screen-safe w-full">
        <FooterSection locale="en" dictionary={dictionary.footer} hideCTA />
      </div>
    </div>
  );
}
