...
const PORTFOLIO_PROJECTS = [
  ...
  },
  {
    ...
    description:
      'Modern analytics dashboard with real-time data visualization and responsive design.',
  ...
  },
  {
    ...
    category: 'Web Development',
    description:
      'High-performance corporate website with SEO optimization and multilingual support.',
  ...
  },
  {
    ...
    category: 'Full Stack',
    description:
      'Appointment booking platform with calendar integration and automated notifications.',
    ...
    <main className="min-h-screen bg-[#050505]">
      ...
      <section className="relative overflow-hidden pt-12 pb-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <div className="mb-6">
              <PulseBadge text={projectsDict.badge} />
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <CornerGlowButton href="/en/services">View Services</CornerGlowButton>
            </div>
          </motion.div>
        </div>
      </section>
