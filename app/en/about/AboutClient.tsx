...
const linkPatterns: Record<string, string> = {
  ...
  'e-commerce stores': '/en/services/ecommerce',
  'web applications': '/en/services/web-development',
  'SEO optimization': '/en/services/seo',
      ...
      <section className="py-20 border-t border-white/5">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-zinc-400 mb-8 max-w-2xl">{aboutPage.cta.description}</p>
