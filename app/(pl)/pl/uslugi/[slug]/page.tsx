...
const SERVICES_CONTENT = {
  webDevelopment: {
    ...
    badge: 'Programowanie',
    description:
      'Profesjonalne tworzenie stron i aplikacji webowych w React, Next.js i Node.js. Od prostych landing page po złożone platformy - tworzę skalowalne, wydajne rozwiązania dopasowane do potrzeb Twojego biznesu.',
    features: [
  ...
  webDesign: {
    ...
    badge: 'Design',
    description:
      'Nowoczesny, responsywny design stron skoncentrowany na doświadczeniu użytkownika i konwersji. Tworzę piękne interfejsy, które nie tylko świetnie wyglądają, ale też zamieniają odwiedzających w klientów.',
    features: [
      'Projektowanie UI/UX',
      'Responsywny Design',
  ...
  seo: {
    ...
    badge: 'SEO',
    description:
      'SEO techniczne, optymalizacja on-page i poprawa wydajności dla lepszych pozycji w Google. Zostań znaleziony przez klientów aktywnie szukających Twoich usług.',
    features: [
      'Audyt Techniczny SEO',
      'Optymalizacja On-Page',
      'Optymalizacja Core Web Vitals',
      'Znaczniki Schema (JSON-LD)',
      'Lokalne SEO (Google Moja Firma)',
      'Badanie Słów Kluczowych i Strategia',
    ],
    ctaText: 'Zamów Audyt SEO',
  },
  ecommerce: {
    title: 'Sklepy Internetowe & E-commerce',
    badge: 'E-commerce',
    description:
      'Profesjonalne rozwiązania e-commerce z integracją płatności, zarządzaniem magazynem i optymalizacją konwersji. Uruchom swój sklep online i zacznij sprzedawać klientom na całym świecie.',
    features: [
      'Dedykowane Rozwiązania E-commerce',
      'Integracja Płatności (Stripe, PayPal)',
      'Systemy Zarządzania Magazynem',
      'Optymalizacja Koszyka',
      'Wsparcie Wielowalutowe i Wielojęzyczne',
      'Zarządzanie Zamówieniami i Analityka',
    ],
    ctaText: 'Uruchom Sklep',
  },
};
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-zinc-400 text-lg mb-10 max-w-xl mx-auto font-light">
              Porozmawiajmy o Twoim projekcie i zobaczmy, jak mogę Ci pomóc osiągnąć Twoje cele.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <CornerGlowButton>{service.ctaText}</CornerGlowButton>
              <CornerGlowButton href="/pl#contact">Kontakt</CornerGlowButton>
            </div>
          </motion.div>
        </div>
      </section>
