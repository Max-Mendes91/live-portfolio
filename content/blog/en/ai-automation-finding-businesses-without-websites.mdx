export const metadata = {
  title: "AI System for Finding Businesses Without Websites | Max Mendes",
  slug: "ai-automation-finding-businesses-without-websites",
  metaDescription: "AI-powered automation workflow finding Polish SMBs without websites. OpenClaw for lead research, mockup generation & personalized outreach. +48 502 742 941",
  keywords: ["AI automation", "agentic workflow", "OpenClaw", "lead generation", "Polish SMB", "automated outreach", "web development automation"],
  ogTitle: "How I Built an AI System to Find Polish Businesses Without Websites",
