export const metadata = {
  title: "OpenClaw: How I Find Businesses Without Websites | Max Mendes",
  slug: "ai-automation-finding-businesses-without-websites",
  metaDescription: "I built an AI system with OpenClaw to automatically find local businesses stuck on Booksy and Instagram. Here's how web developers can use it for lead generation.",
