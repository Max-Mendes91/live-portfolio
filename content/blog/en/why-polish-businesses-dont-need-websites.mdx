export const metadata = {
  ...
  metaDescription: "Why Polish SMBs think websites are unnecessary, how Booksy and Instagram dominate, and why that creates opportunity. From the ground in Częstochowa. +48 502 742 941",
  keywords: ["why small businesses don't need websites", "Polish small business digital marketing", "Booksy vs website", "Instagram for business Poland", "local business online presence"],
...
[IMAGE: Split-screen mockup showing a Booksy profile vs a custom website for the same business, alt: "Comparison of Booksy profile and custom website for Polish nail salon"]
