export const metadata = {
  ...
  metaDescription: "Real website prices for small businesses in Poland: agencies, freelancers, templates. What cheap costs long-term. Fixed pricing from a local developer. +48 502 742 941",
  keywords: ["how much does a website cost for a small business Poland", "website cost Poland", "web developer Poland", "small business website price Poland", "website price Czestochowa"],
  ogTitle: "Website Costs in Poland: What You Actually Pay (and What You Don't See Coming)",
...
[IMAGE: Screenshot comparison of a fast-loading local business website vs a bloated one, alt: "Website loading speed comparison for small business in Poland"]
