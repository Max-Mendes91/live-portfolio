...
- A database dump is useless for finding anyone. Without the server secret you cannot reverse the offset, so the leaked point is a random spot a few hundred metres from a home, not the home.
