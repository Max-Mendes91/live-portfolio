export const metadata = {
  title: "Dlaczego Polskie Małe Firmy Nie Potrzebują Stron (I Dlaczego Mimo To Je Buduję) | Max Mendes",
  slug: "dlaczego-polskie-firmy-nie-potrzebuja-stron",
  metaDescription: "Dlaczego polskie SMB uważają, że strony są zbędne, jak Booksy i Instagram dominują rynek, i dlaczego to właśnie tworzy szansę. Z Częstochowy. +48 502 742 941",
  keywords: ["dlaczego firmy nie potrzebują stron", "polski biznes marketing cyfrowy", "Booksy czy strona", "Instagram dla biznesu Polska", "obecność online lokalne firmy", "strony internetowe Częstochowa", "web developer Częstochowa"],
...
[IMAGE: Mockup podzielony na ekran pokazujący profil Booksy vs niestandardową stronę dla tego samego biznesu, alt: "Porównanie profilu Booksy i niestandardowej strony dla polskiego salonu paznokci"]
