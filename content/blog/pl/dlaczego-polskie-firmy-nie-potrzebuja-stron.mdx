export const metadata = {
  ...
  cta: {
    title: "Gotowy posiadać zamiast wynajmować?",
    description: "Buduję stronę, Ty zatrzymujesz klientów. Bez prowizji platform, bez gier z algorytmem. Twoja firma, Twoja infrastruktura.",
    primaryButton: "Darmowy mockup Twojej strony",
